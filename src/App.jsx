...
const MATERIAS_FILTER = ['Todas', 'Compensación y beneficios', 'Habilidades para la gestión de equipos', 'Digitalización y analytics', 'Transformación digital en RRHH']
