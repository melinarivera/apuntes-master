...
export default function UploadModal({ onClose, onSuccess }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const { error: dbError } = await supabase.from('apuntes').insert({
        autor: form.autor,
  ...
  if (status === 'success') {
    return (
      <div style={overlayStyle} onClick={onClose}>
        <div style={{ ...modalStyle, padding: '3rem', textAlign: 'center' }}>
      ...
      <div style={modalStyle}>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '13px', color: 'var(--text-tertiary)', marginTop: '2px' }}>
              Comparte lo que tienes con el grupo
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit} style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div
            ...
            style={{
              border: `2px dashed ${dragOver ? 'var(--indigo)' : file ? '#0F766E' : 'var(--border-strong)'}`,
              borderRadius: 'var(--radius-md)',
              padding: '1.5rem',
              textAlign: 'center',
              cursor: 'pointer',
              background: dragOver ? 'var(--indigo-light)' : file ? '#CCFBF1' : 'var(--surface)',
              transition: 'all 0.2s',
            }}
          >
            <input
          ...
          <div>
            ...
            <input
              style={inputStyle}
              placeholder="Ej: Resumen tema 4 — valoración de empresas"
              value={form.titulo}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 100px', gap: '12px' }}>
            <div>
              ...
              <input
                style={inputStyle}
                placeholder="De qué va, qué temas cubre…"
          ...
          <button
            ...
            style={{
              padding: '13px',
              background: (!file || status === 'uploading') ? 'var(--border-strong)' : 'var(--indigo)',
              color: '#fff',
              borderRadius: 'var(--radius-md)',
              fontSize: '15px',
              fontWeight: 500,
